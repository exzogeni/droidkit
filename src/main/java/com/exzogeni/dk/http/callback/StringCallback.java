...
public class StringCallback implements HttpCallback<String> {
  ...
  @Override
  public String onSuccess(int statusCode, @NonNull Map<String, List<String>> headers, @NonNull InputStream content)
      throws Exception {
  ...
  public void onSuccess(int statusCode, @NonNull Map<String, List<String>> headers, @NonNull String content) {
    Logger.info(content);
  }
